...
meson b -Dgallium-va=disabled -Dgallium-drivers=virgl,zink,swrast -Ddri3=enabled -Dvulkan-drivers= -Dglx=xlib -Dplatforms=x11,wayland -Dbuildtype=release -Db_lto=true -Dcpp_args="-Wno-typedef-redefinition -O3 -march=armv8.2-a+crc+simd+crypto -mtune=cortex-a76.cortex-a55" -Dc_args="-Wno-typedef-redefinition -O3 -march=armv8.2-a+crc+simd+crypto -mtune=cortex-a76.cortex-a55"
